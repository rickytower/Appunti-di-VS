...
\begin{figure}[thbp]
	...
	\caption{$s$ è lo stato in cui è vera $wp(F,S)$ e $s'$ è lo stato in cui è vera $F$. $S$ è un insieme di statements o istruzioni e $F$ è una formula della logica del primo ordine.}
	\label{fig:wp}
\end{figure}
